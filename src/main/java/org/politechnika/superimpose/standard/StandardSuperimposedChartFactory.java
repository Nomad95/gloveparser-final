...
public class StandardSuperimposedChartFactory {
    ...
    public Superimposed getSuperimposedChartGenerator() {
        return new StandardSuperimposedChart(
                new TimeFrequencyAnalyzer(),
                new SeriesTransformer(new SeriesInterpolator(new DirectLinearInterpolation())),
                new StandardProjection());
    }
}
